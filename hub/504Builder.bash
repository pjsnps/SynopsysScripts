#!/usr/bin/bash
#SCRIPT: 504Builder.bash
#AUTHOR: pjalajas@synopsys.com
#DATE: Fri Jan 22 03:46:02 UTC 2021
#VERSION: 2101220626Z
#CHANGELOG: gnu parallel works, cleaning up a bit

#PURPOSE:  Input dir of bdio jsonld files; output a very large 504 MB bdio file for stress testing Black Duck (Hub) scan uploading.  By manipulating a known-good 81 MB "tomtiger10" bdio file.  504/81=6.2, so need to copy the bdio-entry-# files 7 times to exceed 504 MB.
