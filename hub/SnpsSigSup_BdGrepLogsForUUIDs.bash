#!/usr/bin/bash
#SCRIPT: hub/SnpsSigSup_BdGrepLogsForUUIDs.bash
...
#PURPOSE: Input lists of search term strings, output matching Synopsys Black Duck (Hub) log records scans (scan, code location, ...so far).  
...
export SINCE="2021-01-12T23:00:00"  # Date range of interest in docker container logs  TODO local or utc?
...
f_stringsToPattern() {
  #input stack of strings, output grep PATTERN like "(string1|string2...)"
...
f_getContainerIDs  # docker ps | cut
